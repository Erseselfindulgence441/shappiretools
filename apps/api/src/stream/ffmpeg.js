...
const convertAudio = async (streamInfo, res) => {
    const supportsCover = !streamInfo.audioCopy && ['mp3', 'flac', 'm4a'].includes(streamInfo.audioFormat);
    const embedCover = supportsCover && typeof streamInfo.cover === 'string';
    const args = ['-i', streamInfo.urls];
